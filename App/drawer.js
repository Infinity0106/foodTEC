  ...
  render() {
    ...
    return (
      <SideMenu3D
        ...
        BackgroundView={
          <View style={{ flex: 1, backgroundColor: "#EC5C00" }} />
        }
        Items={[
          {
            text: (
            ...
            renderScene: <MyProducts uid={this.state.uid} />
          },
          {
            text: (
              <View>
          ...
          },
          {
            text: (
              <View>
                ...
                >
                  <Ionicon name="ios-add-circle" size={30} color="#fff" />{" "}
                  Publicar
                </Text>
                <View
                  style={{
            ...
            renderScene: <Publish uid={this.state.uid} />
          },
          {
            text: (
              <View>
                ...
                >
                  <Ionicon name="ios-paper" size={30} color="#fff" /> Mis
                  Pedidos
                </Text>
                <View
                  style={{
            ...
            renderScene: <MyPedidos uid={this.state.uid} />
          },
          {
            text: (
              <View>
            ...
            renderScene: <MyOrders uid={this.state.uid} />
          },
          {
            text: (
              <View>
                ...
                >
                  <OctIcon name="sign-out" size={30} color="#fff" /> Cerrar
                  Sesion
                </Text>
                <View
                  style={{
