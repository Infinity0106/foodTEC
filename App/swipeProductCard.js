    ...
    return (
      <Swipeout style={styles.swipe} right={[{
        ...
        onPress:(()=>{
          var self=this;
          console.log("pressed");
          firebase.database().ref().child('products').child(this.props.data.key).remove().then(()=>{
            firebase.storage().ref().child("products").child(this.props.data.key+".jpg").delete().then()
            self.props.getData();
          })
        }).bind(this),
